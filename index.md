<div align=center>   
    <img alt="main" src="img/Copyc.png" width=450>
</div>
<br/>
...
우리가 함께 만들어 나갈 Copyc에서는 누구나 상업용으로 쓸 수 있도록 자신이 직접 찍은 사진들을 공유한다.
항상 우리 주변에 있지만 사진으로는 잘 찍지 않는 길거리, 강의실, 영화관 사진 모두 웹툰 작가들에게는 소중한 자원이다.

서울에 사는 작가는 도심 사진을 공유한다.
부산에 작가는 바닷가 사진을 공유한다.
작가 지망생 학생은 학교 사진을 공유한다.
Copyc에서 나누게 될 누군가에게는 쓸모없을 그 사진들이 웹툰 작가들에게는 무엇보다도 필요했던 자원이다.
...
## 6. 시스템 구성도
<img src="img/시스템구성도.png" width=500>
<br/>
